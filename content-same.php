<div class="col-md-6 container-same-item">
	<div class="box-same-item">
        ...
        <div class="title-audio" style="padding:10px 0 0 10px; float: left;">
            <a href="<?php the_permalink();?>" title="<?php the_title(); ?>" style="padding-bottom: 10px; display: inline-block;"><?php echo $post->post_title; ?></a>
            <p class="view-size">
    ...
    <a href="<?php the_permalink();?>" title="<?php the_title(); ?>" class="btn_dowload"><i class="fas fa-arrow-alt-circle-down"></i></a>
</div>
